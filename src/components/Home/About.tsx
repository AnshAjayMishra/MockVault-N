                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 mb-8">
                      Today, we're a team of passionate creators, engineers, and
                      visionaries working together to build the future we want
                      to see. We believe in pushing boundaries, embracing
                      challenges, and never settling for "good enough."
                    </p>
