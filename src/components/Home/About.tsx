...
import { ShieldCheck, LockKeyhole, ArrowRight, Lightbulb, Users , Shield ,Zap ,Compass ,Rocket} from "lucide-react";
  ...
  return (
    ...
    <section className="py-20 bg-black text-white">
      <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Redefining what's possible through <span className="text-purple-400">innovative solutions</span>
              </h2>
              <p className="text-zinc-400 mb-6">
                Founded in 2020, we set out to challenge the status quo and create products that empower people to
                achieve more. Our journey began with a simple idea: technology should adapt to humans, not the other way
                around.
              </p>
              <p className="text-zinc-400 mb-8">
                Today, we're a team of passionate creators, engineers, and visionaries working together to build the
                future we want to see. We believe in pushing boundaries, embracing challenges, and never settling for
                "good enough."
              </p>
        ...
        <div className="mt-16">
        <div className="flex items-center justify-center mt-12"> <Link href="/courses" target="black" ></Link></div>
    </div>
      </div>
    </section>
  ...
  <div className="container mx-auto px-6">
    <div className="text-center mb-20">
      ...
      <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
       <span className="text-white"> Principles that</span> <span className="text-blue-400">guide us</span>
      </h2>
      <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
        These core values define our culture and shape every decision we make — from product development to how we
