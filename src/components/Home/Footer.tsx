  ...
  <p className="text-sm text-gray-400">
    Master your skills with interactive courses and accelerate your career growth.
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2">
              <li><Link href="/career/job-board" className="hover:text-white transition-colors">Job Board</Link></li>
              <li><Link href="/career/resume-builder" className="hover:text-white transition-colors">Resume Builder</Link></li>
              <li><Link href="/career/interview-prep" className="hover:text-white transition-colors">Interview Prep</Link></li>
